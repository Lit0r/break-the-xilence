...
xst -ifn xst.scr
move clocking_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clocking_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clocking_exdes.ucf clocking_exdes

echo 'Running map'
map -timing -pr b clocking_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clocking_exdes -w routed.ncd routed.v
cd ..
